...
import { createTask, getTasksByTitle, getAllTasks, getTasksByUser, updateTask, deleteTask} from "../controllers/taskController";
...
export const taskRoutes = (app: Express) => {
    ...
    // Obter todas as tarefas por título
    app.get("/tasks/:title", (req: Request, res: Response) => getTasksByTitle(req, res));

    // Obter todas as tarefas
    app.get("/tasks/", (req: Request, res: Response) => getAllTasks(req, res));
